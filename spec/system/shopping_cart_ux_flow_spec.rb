...
RSpec.describe 'Shopping Cart User Experience', type: :system do
 it 'allows items to be added and removed from the cart from the product page'
 ...
 #     'Remove from Cart',
 #     href: remove_from_carts_path(product_id: product.id)
 #   )
 #
 ...
 #   expect(page).to have_link(
 #     'Add to Cart',
 #     href: add_to_carts_path(product_id: product.id)
 #   )
 # end
end
